...
$(function() {
    ...
    var vm = new Vue({
        ...
        ready: function() {
            ...
            $.AJAX({
                type: 'get',
                url: config.basePath + 'product/svProduct/getNotPublishSpu',
                data: {
                    spuId: shopSpuId,
                },
                success: function(data) {
                    ...
                    setTimeout(function() {
                        WeiXinShare({
                            ...
                            mainUrl: vm.banner[0].imgMainUrl,
                            success: function() {},
                            cancel: function() {},
                        });
                    }, 100);
        ...
        methods: {
            ...
            submitShopNow: function() {
                if (vm.type == 1) {
                    ...
                    if (sessionStorage.getItem('fenYongShareId')) {
                        data.shareId = parseInt(sessionStorage.getItem('fenYongShareId'));
                    }
                    $.AJAX({
                        type: 'post',
