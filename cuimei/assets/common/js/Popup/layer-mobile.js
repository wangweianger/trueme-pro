...
PopLayer.prototype.customHtml=function(json){
    ...
    str+='<div class="main" style="'+this.setting.style+'"><div class="maminContent">';
...
PopLayer.prototype.iframe=function(json){
    ...
    $(window).on('resize',function() {
        ...
        if(_this.setting.yesHtml){
            heightTwo=$('div.main').height()-20;
        }else{
            heightTwo=$('div.main').height();     
        }
...
PopLayer.prototype.miss=function(json){
    ...
    var str='<div class="popup popup-hide">';
		str+='<div class="main" style="'+this.setting.style+'"><div class="maminContent maskMain">';
